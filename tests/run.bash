...
if diff <(tail ../tests/output/01-professor.out -n "$NL") <(tail ../tests/expected/01-professor.out -n "$NL"); then
...
if diff <(tail ../tests/output/02-student.out -n "$NL") <(tail ../tests/expected/02-student.out -n "$NL"); then
...
if diff <(tail ../tests/output/03-student.out -n "$NL") <(tail ../tests/expected/03-student.out -n "$NL"); then
...
if diff <(tail ../tests/output/04-professor.out -n "$NL") <(tail ../tests/expected/04-professor.out -n "$NL"); then
...
if diff <(tail ../tests/output/05-student.out -n "$NL") <(tail ../tests/expected/05-student.out -n "$NL"); then
...
if diff <(tail ../tests/output/06-professor.out -n "$NL") <(tail ../tests/expected/06-professor.out -n "$NL"); then
...
if diff <(tail ../tests/output/07-student.out -n "$NL") <(tail ../tests/expected/07-student.out -n "$NL"); then
...
if diff <(tail ../tests/output/08-admin.out -n "$NL") <(tail ../tests/expected/08-admin.out -n "$NL"); then
