...
/**
 * This class is the boilerplate for every RPC call.
 * It's responsible for retrying requests or handling Response exceptions
 */
public abstract class RPCFrontendCall {
    ...
    /**
     * RPC Execution template. When called, it uses abstract methods 'createStubForRequest' for generating stubs and 'requestCall'
     * for creating and executing requests. In case of an inactive server the function is recalled.
     *
    ...
    /**
     * Abstract method for generating stubs.
     * When called this method should handle all the logic required to create a new stub
     *
    ...
    /**
     * Abstract method for executing RPC requests
     * When called this method should handle all the logic required to create a new RPC request and executing it
     * using the stub generated by 'createStubForRequest'
     *
     * @throws StatusRuntimeException
     */
