...
public class StudentService extends StudentServiceGrpc.StudentServiceImplBase {
  ...
  public void enroll(
    ...
    StudentClassServer.EnrollResponse.Builder response =
    ...
    if (!_properties.get("isActive")) {
      ...
      synchronized (this._classObj) {
        ...
        } else if (currentClassState.getEnrolledList().stream().filter(o -> o.getStudentId().equals(studentId)).findFirst().isPresent()) {
